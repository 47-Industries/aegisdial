          ...
          children: [
            ...
            ...[
              ...
              ('What is Email Shield?',
                  'Link your Gmail or Outlook account (read-only OAuth) and AegisDial scans for signs of compromise — rogue forwarding rules, unusual sent activity, and unauthorized access patterns. We never send, delete, or modify your email.'),
              ('How do I check a phone number?',
                  'Tap "Check a Number" on the home screen and enter any phone number. AegisDial queries scam databases, carrier records, and community reports to return a trust score, verdict, and evidence.'),
