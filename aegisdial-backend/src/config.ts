...
const schema = z.object({
  ...
  APPLE_CLIENT_ID: z.string().default('com.aegisdial.ios'),
  APP_ATTEST_BUNDLE_ID: z.string().default('com.aegisdial.ios'),
  ...
  APPLE_BUNDLE_ID: z.string().default('com.aegisdial.ios'),
