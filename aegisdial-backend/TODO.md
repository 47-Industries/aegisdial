...
- [ ] **App Store Connect — create subscription products at correct prices**:
  ...
  - `com.aegisdial.app.recovery.session` = **$99 one-time** (NON-CONSUMABLE in-app purchase, NOT auto-renewable subscription) — the wedge SKU. Backend grants 30-day Pro on verify; iOS paywall offers it next to "$49.99/mo" as a "just need help once" option.
