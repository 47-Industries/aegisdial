...
final class CallerIDExtension: LiveCallerIDLookupExtension {
  ...
  // "$(AppIdentifierPrefix)com.aegiadial.ios.shared".
  //
  ...
  private static func readSharedKeychainToken() -> String? {
    var q: [String: Any] = [
      ...
      kSecAttrAccount as String: "com.aegiadial.ios.authToken",
      kSecReturnData as String: true,
      kSecMatchLimit as String: kSecMatchLimitOne,
    ]
    #if !targetEnvironment(simulator)
    q[kSecAttrAccessGroup as String] = "com.aegiadial.ios.shared"
    #endif
    var out: AnyObject?
