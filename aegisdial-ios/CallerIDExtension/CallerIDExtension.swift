...
final class CallerIDExtension: LiveCallerIDLookupExtension {
  ...
  // "$(AppIdentifierPrefix)com.fortyseven.aegisdial.shared".
  //
  ...
  private static func readSharedKeychainToken() -> String? {
    var q: [String: Any] = [
      ...
      kSecAttrAccount as String: "com.fortyseven.aegisdial.authToken",
      kSecReturnData as String: true,
      kSecMatchLimit as String: kSecMatchLimitOne,
    ]
    #if !targetEnvironment(simulator)
    q[kSecAttrAccessGroup as String] = "com.fortyseven.aegisdial.shared"
    #endif
    var out: AnyObject?
